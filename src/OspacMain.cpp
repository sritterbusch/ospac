	...
	for(unsigned i=0;i<arg.size();i++)
	{
		if(isOption(arg[i]))
		{
			...
			if(arg[i]=="help")
			{
				...
				std::cout << std::endl;
				std::cout << " Output targets:" << std::endl;
				...
				std::cout << "  --artist [text] Set artist tag to [text] if this exists in output" << std::endl;
				std::cout << "  --album [text]  Set album tag to [text] if this exists in output" << std::endl;
				std::cout << "  --comment [text] Set comment tag to [text] if this exists in output" << std::endl;
				std::cout << "  --category [text] Set category tag to [text] if this exists in output" << std::endl;
				std::cout << "  --episode [text] Set episode tag to [text] if this exists in output" << std::endl;
				std::cout << "  --year [text]   Set year tag to [text] if this exists in output" << std::endl;
				std::cout << "  --image [file]  Set image tag to [file] if this exists in output" << std::endl;
				std::cout << std::endl;
				...
				std::cout << " Mix 2 mono voice recordings with crossgate, leveling and normalization:" << std::endl;
